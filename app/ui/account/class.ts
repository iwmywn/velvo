const boxClass =
  "relative mb-12 w-full after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[1px] after:bg-stone-200 hover:after:bg-black after:transition-all after:duration-300";
const inputClass =
...
const buttonClass = "bg-black py-4 text-xs font-medium text-white group";
